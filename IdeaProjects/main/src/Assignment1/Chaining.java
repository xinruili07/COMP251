...
public class Chaining {
    ...
    public int insertKey(int key){
        ...
        int HashIndex = chain(key);

        // The number of other keys in the same bin at the time of insertion is returned as the number of collisions
        int numberCollisions = Table.get(HashIndex).size();

        // Insert the key in the appropriate bin
